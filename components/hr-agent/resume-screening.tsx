...
export function ResumeScreening() {
  ...
  async function fetchScreenings() {
    ...
    try {
      ...
      if (filterJobId && filterJobId !== "all")
        params.append("job_id", filterJobId);
      if (filterStatus && filterStatus !== "all")
        params.append("status", filterStatus);
      const res = await fetch(
        `${API_BASE}/resume-screening/screenings/?${params}`,
      );
  ...
  async function handleUploadResume() {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/resume-screening/screenings/upload`,
        {
          method: "POST",
          body: formData,
        },
  ...
  async function handleCreateJob() {
    ...
    try {
      ...
      if (jobFile) {
        ...
        if (jobForm.required_skills)
          formData.append("required_skills", jobForm.required_skills);
        if (jobForm.min_experience_years)
          formData.append("min_experience_years", jobForm.min_experience_years);
        if (jobForm.education_requirement)
          formData.append(
            "education_requirement",
          ...
          >
            ...
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Fill in details manually or upload a PDF/DOCX file. A unique
                  JD_ID is generated automatically.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Share this ID with candidates. They must include it in
                      their email subject line.
                    </p>
                    <div className="flex items-center gap-2 p-3 bg-secondary rounded-lg">
                      <code className="text-lg font-bold text-primary flex-1">
                        {createdJob.jd_id}
                      </code>
                      <Button
                        size="sm"
                        variant="ghost"
                        onClick={handleCopyJdId}
                        className="gap-1"
                      >
                        {copied ? (
                ...
                <div className="space-y-4">
                    ...
                    >
                      {jobFile ? (
                        ...
                        <span className="text-sm text-muted-foreground">
                          Click to browse PDF or DOCX — description will be
                  ...
                  {jobFile && (
                    <div className="flex items-center gap-2 text-sm text-emerald-400 bg-emerald-500/10 rounded-lg px-3 py-2">
                      ...
                      Description will be extracted from{" "}
                      <span className="font-medium">{jobFile.name}</span>
                    </div>
                  )}
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      {!jobForm.title
                        ...
                        : !jobForm.required_skills
                          ...
                          : !jobForm.min_experience_years
                            ? "Enter min experience years"
                            : !jobFile && !jobForm.description
                              ? "Upload a PDF file or paste job description"
                              : ""}
                    </p>
                  )}
                </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="screenings" className="mt-4">
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-1">
              <Card className="bg-card border-border overflow-y-auto h-[80vh]">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="invalid_application">
                          Invalid
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <CardTitle className="text-foreground">
                          {selectedScreening.candidate_name}
                        </CardTitle>
                        <CardDescription>
                      ...
                      <Badge
                        variant="outline"
                        className={
                          statusConfig[selectedScreening.status]?.color
                        }
                      >
                    ...
                    <div className="p-4 rounded-lg bg-secondary/50 border border-border">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <div className="text-4xl font-bold text-foreground">
                          {selectedScreening.final_score ?? 0}%
                        </div>
                        <div className="flex-1">
                          <Progress
                            value={selectedScreening.final_score ?? 0}
                            className="h-3"
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        {[
                          {
                            label: "Skills Match",
                            value: selectedScreening.skill_score,
                            weight: "40%",
                          },
                          {
                            label: "Experience",
                            value: selectedScreening.experience_score,
                            weight: "25%",
                          },
                          {
                            label: "Education",
                            value: selectedScreening.education_score,
                            weight: "15%",
                          },
                          {
                            label: "Semantic Relevance",
                            value: selectedScreening.semantic_similarity_score,
                            weight: "20%",
                          },
                        ].map((item) => (
                          <div
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedScreening.evaluation_breakdown
                              ...
                              selectedScreening.evaluation_breakdown.matched_skills.map(
                                (skill) => (
                                  <Badge
                                    key={skill}
                                    variant="outline"
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedScreening.evaluation_breakdown
                              ...
                              selectedScreening.evaluation_breakdown.missing_skills.map(
                                (skill) => (
                                  <Badge
                                    key={skill}
                                    variant="outline"
        ...
        <TabsContent value="upload" className="mt-4">
          <Card className="bg-card border-border max-w-2xl">
            <CardHeader>
              <CardTitle className="text-foreground text-base">
                Screen a Resume (HR Upload)
              </CardTitle>
              <CardDescription>
                Select a job, optionally enter candidate email, then upload
                their resume PDF or DOCX.
              </CardDescription>
            </CardHeader>
                ...
                >
                  ...
                  <div className="grid grid-cols-4 gap-2 text-xs">
                    {[
                      ...
                      {
                        label: "Experience",
                        value: uploadResult.experience_score,
                      },
                      {
                        label: "Education",
                        value: uploadResult.education_score,
                      },
                      {
                        label: "Semantic",
                        value: uploadResult.semantic_similarity_score,
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                        className="text-center bg-secondary/50 rounded p-2"
                      >
        ...
        <TabsContent value="gmail" className="mt-4">
          <Card className="bg-card border-border max-w-2xl">
            <CardHeader>
              ...
              <CardDescription>
                Fetches the latest unread Gmail email with a PDF/DOCX
                attachment. The email subject must contain the Job ID (e.g.{" "}
                <code className="text-primary">Application JD_X7K2P</code>). If
                no Job ID is found in the subject, the application is
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-3 rounded-lg bg-secondary/50 border border-border space-y-2">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  <p>
                    1. Candidate emails resume to your Gmail with subject
                    containing the Job ID
                  </p>
                  <p>2. Click "Fetch & Screen" below</p>
                  <p>
                    3. System reads latest unread email, extracts Job ID from
                    subject
                  </p>
              ...
              {jobs.length > 0 && (
                <div className="space-y-1">
                  <Label className="text-xs text-muted-foreground">
                    Active Job IDs to share with candidates:
                  </Label>
                  <div className="flex flex-wrap gap-2">
                    {jobs.map((job) => (
                      <div
                        key={job._id}
                        className="flex items-center gap-1.5 bg-secondary rounded-md px-2 py-1"
                      >
                        ...
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText(job.jd_id);
                          }}
              ...
              <div className="p-3 rounded-lg bg-primary/5 border border-primary/20">
                ...
                <p className="text-xs font-medium text-foreground">
                  ...
                  <span className="text-primary">
                    Application {jobs[0]?.jd_id || "JD_XXXXX"}
                  </span>
                </p>
                <p className="text-xs text-muted-foreground">
                ...
                >
                  <div className="flex items-center gap-2 font-medium text-foreground">
                    ...
                    {gmailResult.status === "shortlisted"
                      ? "Shortlisted ✅"
                      : gmailResult.status === "invalid_application"
                        ? "Invalid Application ⚠️"
                        : "Rejected ❌"}
                    {gmailResult.final_score !== undefined && (
                      <span className="ml-auto text-lg font-bold">
                        {gmailResult.final_score}/100
                      </span>
                    )}
                  </div>
                  {gmailResult.sender_email && (
                    <p className="text-xs text-muted-foreground">
                      From: {gmailResult.sender_email}
                    </p>
                  )}
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <button
                            onClick={() =>
                              navigator.clipboard.writeText(selectedJob.jd_id)
                            }
                  ...
                  <CardContent className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="p-3 rounded-lg bg-secondary/30">
                        ...
                        <p className="text-sm font-medium text-foreground">
                          {selectedJob.education_requirement || "Not specified"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-4 rounded-lg bg-secondary/30 border border-border">
                      ...
                      <p className="text-xs text-muted-foreground mb-3">
                        Candidates must include the Job ID in their email
                        subject:
                      </p>
                      <div className="flex items-center gap-2 p-2 bg-secondary rounded-lg">
                        <code className="text-sm text-primary flex-1">
                          Application {selectedJob.jd_id}
                        </code>
                        <Button
                          size="sm"
                          variant="ghost"
